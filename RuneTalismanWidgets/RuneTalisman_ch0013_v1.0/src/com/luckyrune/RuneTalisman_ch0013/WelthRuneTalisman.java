...
public class WelthRuneTalisman extends AppWidgetProvider implements
		View.OnClickListener {
	private static final String TAG = "WelthRuneTalisman";
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
		...
		for (int i = 0; i < N; i++) {
			...
			Intent intent = new Intent(context,
					com.luckyrune.RuneTalisman_ch0013.RuneInfo.class);
