...
public class RuneWidgetProvider extends AppWidgetProvider implements
		View.OnClickListener {
	private static final String TAG = "RuneWidgetProvider";
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
		...
		for (int i = 0; i < N; i++) {
			...
			Intent intent = new Intent(context,
					com.luckyrune.RuneWidget.RuneInfo.class);
