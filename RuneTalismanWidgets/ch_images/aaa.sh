...
color="#a30000"
convert -size 700x400 xc:none -border 3 -alpha transparent -background none -fill 'rgba(255,255,255,0)' -stroke '#a30000' -strokewidth 4 -draw "roundRectangle 15,20 710,380 15,15" circle.png
convert -size 700x400 xc:transparent -font runes-germanic-kern-cc-germanic-kern-cc -pointsize 50 -channel RGBA -gaussian 0x6 -fill '#a30000' -draw "text 350,166 ',t.s.u,'" ch0010_script_700x400.png
