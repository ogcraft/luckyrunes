...
public class GamerRuneTalisman extends AppWidgetProvider implements
		View.OnClickListener {
	private static final String TAG = "GamerRuneTalisman";
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
		...
		for (int i = 0; i < N; i++) {
			...
			Intent intent = new Intent(context,
					com.luckyrune.RuneTalisman_ch0025.RuneInfo.class);
